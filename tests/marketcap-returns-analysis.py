...
returntickerlow = yf.download(ticker_list_low, period='1y', auto_adjust=True)['Close']#type: ignore
returns_low= {}
...
returntickerhigh = yf.download(highcap_sample['Ticker'].tolist(), period='1y', auto_adjust=True)['Close'] #type:ignore
returns_high= {}
...
#plt.plot(lowcap_merge['Market Value'], ww10**(m*np.log10(lowcap_merge['Market Value']) + b), color='red')
